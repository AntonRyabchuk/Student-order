...
(
	...
	FOREIGN KEY (p_office_area_id) REFERENCES jc_country_struct(area_id)
		ON DELETE RESTRICT
);
...
(
    ...
    w_streetcode integer not null,
    w_building varchar(10) not null,
    w_extension varchar(10),
    w_apartment varchar(10),
    w_university_id integer not null,
    w_student_number varchar(20) not null,
    certificate_id varchar(20) not null,
    register_office_id integer not null,
    marriage_date date not null,
    PRIMARY KEY (student_order_id),
   	FOREIGN KEY (h_streetcode) REFERENCES jc_street(street_code) ON DELETE RESTRICT,
   	...
   	FOREIGN KEY (w_streetcode) REFERENCES jc_street(street_code) ON DELETE RESTRICT,
...
(
    ...
    PRIMARY KEY (student_child_id),
   	...
   	FOREIGN KEY (c_streetcode) REFERENCES jc_street(street_code) ON DELETE RESTRICT,
   	FOREIGN KEY (c_register_office_id) REFERENCES jc_register_office(r_office_id) ON DELETE RESTRICT
);

/* индесируем поля для улучшения производительности */
